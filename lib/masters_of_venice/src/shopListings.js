            ...
            <Paper key={shop.key} className="paperCube" zDepth={4} >
              ...
              <div className="stats">
                <Chip className='price'>
                  ...
                  <span className="value">{shop.price}</span>
                </Chip>
                <Chip className={'shares '+((shop.share === false) ? 'hide' : '')} >
                  <FontIcon className="fa fa-line-chart" /><br/>
                  <span className="value">{shop.share}</span>
                </Chip>
                <Chip className={'orders '+((shop.orders === -1) ? 'hide' : '')} >
