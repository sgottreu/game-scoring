...
const actionStats = {
        ...
        'nshipping': { quantity: 0, action: 'buy', move_share: 0, move_price: 0, move_orders: 0},
        'sshipping': { quantity: 0, action: 'buy', move_share: 0, move_price: 0, move_orders: 0}
      };
...
class App extends Component {
  ...
  updateStat = (type, e) => {
    ...
    state.actionStats[ key ][ type ] = parseInt(e.target.value);
