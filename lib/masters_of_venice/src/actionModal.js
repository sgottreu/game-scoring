...
class ActionModal extends Component {
  ...
  render() {
    let {shops, stocks, open, handleClose, openActionModal, selectedAction, handleActionChange, initAction, 
      changeActionQuantity, changeActionEvent, actionStats, saveAction} = this.props;
