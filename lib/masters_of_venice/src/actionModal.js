...
class ActionModal extends Component {
  ...
  render() {
    let {shops, open, handleClose, openActionModal, selectedAction, handleActionChange,  
          changeActionQuantity, changeActionEvent, actionStats, saveAction, actionMsg, currentPlayer, 
          showDividend, actionPayments, actions} = this.props;
    ...
    return (
      <div className="actions">
        ...
        >
          ...
          <div className={'payments'+((actionPayments.type)? '':'hide')}>{PaymentString}</div>
